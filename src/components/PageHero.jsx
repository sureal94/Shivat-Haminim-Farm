...
export default function PageHero({ heading, text, image }) {
  const { content: { site }, direction } = useLanguage()
  return (
    <section className="relative overflow-hidden bg-forest">
      ...
      <div
        className={`absolute inset-0 ${
          direction === 'rtl'
            ? 'bg-gradient-to-l from-forest via-forest/85 to-forest/55'
            : 'bg-gradient-to-r from-forest via-forest/85 to-forest/55'
        }`}
      />
